namespace PSEngagementSystem
{
    class Program
    {
        ...
        {
            new PersonalSupervisor { ID = 1, Name = "Dr. Smith", StudentIDs = new List<int> {1, 2} },
            new PersonalSupervisor { ID = 2, Name = "Dr. Johnson", StudentIDs = new List<int> {3} }
        };
        ...
        static void LogCheckIn(int studentId)
        {
            ...
            Console.WriteLine("Check-in saved permanently!\n");
